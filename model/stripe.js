...
exports.subscription.list = async function({ status, created } = {}){
...
exports.subscription.update = async function({ subscription, plan, quantity, cancel_at_period_end }){
...
exports.customer.subscribe = async function({ id, plan, trial_period_days, quantity }){
